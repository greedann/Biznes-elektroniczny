  ...
  ";
    ...
    public function block_empty_categories_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 40
        $this->loadTemplate("@PrestaShop/Admin/Sell/Catalog/Monitoring/index.html.twig", "@PrestaShop/Admin/Sell/Catalog/Monitoring/index.html.twig", 40, "511126995")->display(twig_array_merge($context, ["grid" => ($context["emptyCategoryGrid"] ?? $this->getContext($context, "emptyCategoryGrid"))]));
        // line 61
        echo "      </div>
    </div>
  ";
...
/* @PrestaShop/Admin/Sell/Catalog/Monitoring/index.html.twig */
class __TwigTemplate_082dc1f389ba764b7a187108ad35652fda6fde9291ebcada188e1bf36bf8555c___511126995 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        parent::__construct($env);
